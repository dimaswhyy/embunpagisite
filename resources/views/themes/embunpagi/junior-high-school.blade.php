...
<section class="my-10">
  <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10"> 
    <div class="rounded-3xl w-full h-96 overflow-hidden relative">
      <img src="{{ asset('storage') }}/SMP-SMA/School Facilities/EPIS JHS&SHS_20230801_111225.jpg" class="w-full h-full object-cover" />
      <div class="absolute top-0 left-0 w-full h-full p-10 text-white flex justify-center items-end text-3xl font-bold bg-gradient-blue-transparent">Junior High School</div>
    </div>
  </div>
</section>
...
<section class="bg-gradient-ivory py-32 relative overflow-hidden">
  <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10"> 
    <div class="pb-20">
      <p class="leading-loose">The curriculum, activities and school culture at EPIS JHS are designed by taking into account the development process of early teens in order to prepare students to be ready to face the next level of lives and begin to become leaders for those closest to them. The cultivation of Islamic values is also strictly applied in the hope that students have a strong foundation in their lives.</p>
    </div>
    <div class="flex flex-col lg:flex-row gap-20 justify-between items-center">
        ...
        <div class="py-8 leading-loose text-center lg:text-left">
          ...
          <ul class="p-0 pb-5">
            ...
            <li class="flex gap-3 items-start text-left">
              <img src="{{ asset('img/item-list-type.svg') }}" class="w-5 h-5 mt-2" />
              <span><strong>EPIS curicullum</strong><br/><em>(Character Building (Anti Bullying & Self-love Campaigns), Tahsin, Tajwid, Muroja'ah, Tahfidz Juz 29)</em></span>
            </li>
          </ul>
        </div>
      </div>
      <div class="w-full lg:w-6/12 relative">
        <div class="relative w-11/12 h-80">
          <img src="{{ asset('storage') }}/SMP-SMA/School Facilities/Class room-8671.jpg" alt="Junior School Image" class="w-full h-full object-cover rounded-3xl relative z-10" />
