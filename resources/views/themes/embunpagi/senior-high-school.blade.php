...
<section class="my-10">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="rounded-3xl w-full h-96 overflow-hidden relative">
            <img src="{{ asset('storage') }}/SMP-SMA/School Facilities/EPIS JHS&SHS_20230801_111216.jpg"
...
<section class="bg-gradient-ivory py-32 relative overflow-hidden">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="pb-20">
            <p class="leading-loose">Ensuring the continuation and sustainable learning of EPIS graduates, we
                established EPIS Senior High in 2022. EPIS Senior High is here as your partner in building our youth to
                be Future Islamic Leaders. Together, we could facilitate them to become Empathetic Islamic Leaders and
                Patriotic Global Citizens that have an Inspiring Grateful Life and be Successful Here & Hereafter.</p>
        </div>
        <div class="flex flex-col lg:flex-row gap-20 justify-between items-center">
                ...
                <div class="py-8 leading-loose text-center lg:text-left">
                    ...
                    <ul class="p-0 pb-5">
                        <li class="flex gap-3 items-start mb-3 text-left">
                            ...
                            <span><strong>Kurikulum Merdeka</strong><br /><em>(Optional Subjects: Physics, Chemistry,
                                    Biology, Sociology, Economics, Geography, Advanced Maths, ICT)</em></span>
                        </li>
                        <li class="flex gap-3 items-start mb-3 text-left">
                            <img src="{{ asset('img/item-list-type.svg') }}" class="w-5 h-5 mt-2" />
                        ...
                        <li class="flex gap-3 items-start text-left">
                            <img src="{{ asset('img/item-list-type.svg') }}" class="w-5 h-5 mt-2" />
                            <span><strong>EPIS curicullum</strong><br /><em>(Adab class, IKIGAI practice, Tahfidz, Life
                                    Skill Program, Literacy & Numeracy Program, English Club, Journalistic
                                    Club)</em></span>
                        </li>
                    </ul>
                </div>
            ...
            <div class="w-full lg:w-6/12 relative">
                <div class="relative w-11/12 h-80">
                    <img src="{{ asset('storage') }}/SMP-SMA/School Facilities/Science Lab.JPG"
                        alt="Senior School Image" class="w-full h-full object-cover rounded-3xl relative z-10" />
