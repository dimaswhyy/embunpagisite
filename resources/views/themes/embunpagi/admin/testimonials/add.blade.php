...
<div class="block w-6/12">
  <h4 class="mb-8 text-xl font-semibold">Add Testimonial</h4>
  <form action="{{ route('testimonials_store') }}" method="post" class="block">
    @csrf
    ...
    <div class="block mb-5">
      ...
      <div class="border rounded-lg mt-1 mb-5 w-full overflow-hidden bg-white">
        <input id="title-input" type="text" name="title" class="border-0 rounded-lg px-3 py-2 text-sm w-full bg-none" placeholder="type name" />
      </div>
    </div>
    <div class="block mb-5">
      <label for="subtitle-input" class="font-semibold text-sm text-gray-600 pb-1 block">Generation</label>
      <div class="border rounded-lg mt-1 mb-5 w-full overflow-hidden bg-white">
        <input id="subtitle-input" type="text" name="subtitle" class="border-0 rounded-lg px-3 py-2 text-sm w-full bg-none" placeholder="type generation" />
      </div>
    </div>
    <div class="block mb-5">
