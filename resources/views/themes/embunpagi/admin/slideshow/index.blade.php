...
<div class="bg-white px-4 py-6 shadow sm:rounded-lg sm:p-6">
  <div class="flex justify-between items-center">
    <h4 class="font-bold text-xl text-blue">Slideshows</h4>
    <a href="{{ route('slideshow_add') }}" class="transition duration-200 bg-blue hover:bg-blue-600 focus:bg-blue-700 focus:shadow-sm focus:ring-4 focus:ring-blue-500 focus:ring-opacity-50 text-white px-5 py-2 rounded-lg text-sm shadow-sm hover:shadow-md font-semibold text-center">Add Slideshow</a>
  </div>
    ...
    <table class="w-full my-5">
      ...
      <tbody>
        ...
        <tr id="data-id-{{ $item->translation[0]->id }}">
          ...
          <td class="text-sm border-b p-3 whitespace-nowrap">
            <a href="{{ route('slideshow_edit', $item->id) }}" class="text-blue">Edit</a>&nbsp;
