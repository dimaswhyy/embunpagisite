...
<section class="my-10">
  <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10"> 
    <div class="rounded-3xl w-full h-96 overflow-hidden relative">
      ...
      <div class="absolute top-0 left-0 w-full h-full p-10 text-white flex justify-center items-end text-3xl font-bold bg-gradient-blue-transparent">Primary School</div>
    </div>
  </div>
</section>
    ...
    <div class="flex flex-col lg:flex-row gap-20 justify-between items-center">
      <div class="w-full lg:w-6/12">
        ...
        <div class="py-8 leading-loose text-center lg:text-left">
          ...
          <p class="text-sm leading-loose"><em>As one of 'Sekolah Penggerak', Embun Pagi Islamic School-Primary has implemented the Kurikulum Merdeka since academic year 2022-2023.</em></p>
        </div>
        <img src="{{ asset('storage') }}/Accreditation-Primary.png" alt="Accreditation A" class="w-auto h-24 m-auto lg:m-0" />
      </div>
      <div class="w-full lg:w-6/12 relative">
        <div class="relative w-11/12 h-80">
          <img src="{{ asset('storage') }}/SD/Extracurricular/Vocal.JPG" alt="Primary School Image" class="w-full h-full object-cover rounded-3xl relative z-10" />
          ...
          <div class="block text-center pb-10">
            <div class="card-flip card-ekskul">
              <div class="card-inner">
                ...
                <div class="card-back">
                  <img src="{{ asset('storage') }}/SD/Extracurricular/Futsal_0101.png" alt="Futsal Image">
                </div>
              </div>
            </div>
          ...
          <div class="block text-center pb-10">
            <div class="card-flip card-ekskul">
              <div class="card-inner">
                ...
                <div class="card-back">
                  <img src="{{ asset('storage') }}/SD/Extracurricular/Taekwondo (6).png" alt="Taekwondo Image">
                </div>
              </div>
            </div>
          ...
          <div class="block text-center pb-10">
            <div class="card-flip card-ekskul">
              <div class="card-inner">
                ...
                <div class="card-back">
                  <img src="{{ asset('storage') }}/SD/Extracurricular/Taekwondo (6).png" alt="Pencak Silat Image">
                </div>
              </div>
            </div>
          ...
          <div class="block text-center pb-10">
            <div class="card-flip card-ekskul">
              <div class="card-inner">
                ...
                <div class="card-back">
                  <img src="{{ asset('storage') }}/SD/Extracurricular/Renang.png" alt="Swimming Image">
                </div>
              </div>
            </div>
          ...
          <div class="block text-center pb-10">
            <div class="card-flip card-ekskul">
              <div class="card-inner">
                ...
                <div class="card-back">
                  <img src="{{ asset('storage') }}/SD/Extracurricular/Robotik.jpg" alt="Robotic Image">
                </div>
              </div>
            </div>
          ...
          <div class="block text-center pb-10">
            <div class="card-flip card-ekskul">
              <div class="card-inner">
                ...
                <div class="card-back">
                  <img src="{{ asset('storage') }}/SD/Extracurricular/Robotik.jpg" alt="Science Image">
                </div>
              </div>
            </div>
          ...
          <div class="block text-center pb-10">
            <div class="card-flip card-ekskul">
              <div class="card-inner">
                ...
                <div class="card-back">
                  <img src="{{ asset('storage') }}/SD/Extracurricular/Lukis (4).png" alt="Painting Image">
                </div>
              </div>
            </div>
          ...
          <div class="block text-center pb-10">
            <div class="card-flip card-ekskul">
              <div class="card-inner">
                ...
                <div class="card-back">
                  <img src="{{ asset('storage') }}/SD/Extracurricular/Traditional Dance.JPG" alt="Traditional Dance Image">
                </div>
              </div>
            </div>
