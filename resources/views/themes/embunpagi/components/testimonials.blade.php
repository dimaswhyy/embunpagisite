...
#testimonial-slider {
    ...
    /* 1. POTONG DI SINI: Memotong kartu yang meluber melewati batas kontainer utama */
    overflow: hidden !important; 
    
    /* 2. BERI RUANG ATAS & BAWAH: Agar avatar mencuat (-55px) dan shadow bawah tidak ikut terpotong */
    padding-top: 60px !important; 
    padding-bottom: 60px !important;
}

#testimonial-slider .splide__track {
    overflow: visible !important; /* Penting! Biarkan kartu "bocor" */
}
...
#testimonial-slider .splide__slide {
    padding: 0 12px; /* Memberikan jarak horizontal antar kartu */
    display: flex;
...
<section class="testimonial-section">
    <div class="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        'batch' => 'Angkatan 2020',
        'description' => 'Embun Pagi Islamic School has been a wonderful place for my child to grow academically and
        spiritually.',
        ],
        ],
        ],
        ...
        'batch' => 'Angkatan 2020',
        'description' => 'The teachers really care, and the learning environment is safe and supportive for every
        student.',
        ],
        ],
        ],
        ...
        'batch' => 'Angkatan 2021',
        'description' => 'Di EMBUN PAGI itu benar-benar belajar yang menyenangkan, karena pembelajaran dari gurunya
        memahami kebutuhan kami sebagai murid.',
        ],
        ],
        ],
        (object)[
        ...
        while ($testimonials->count() < 4) { $testimonials->push($dummyTestimonials[$testimonials->count() %
            $dummyTestimonials->count()]);
            }
            @endphp
                            ...
                            <div class="testimonial-card">
                                ...
                                <div class="testimonial-avatar">
                                    ...
                                    <img src="{{ env('USE_AWS') ? env('AWS_URL') : asset('storage') }}/{{ $trans->image }}"
                                        alt="{{ $trans->title }}">
                                    @else
                                    <img src="{{ asset('img/embun-default-img.jpg') }}" alt="{{ $trans->title }}">
                                    @endif
                                </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        new Splide('#testimonial-slider', {
            type   : 'loop',       // Carousel berputar terus-menerus
            perPage: 4,            // Menampilkan tepat 4 kartu di area dalam kontainer
            perMove: 1,            // Geser 1 kartu setiap kali klik tombol panah
            gap    : '0px',        // Jarak diatur lewat padding CSS di atas agar kalkulasi lebar Splide presisi
            arrows : true,         // Tombol panah aktif
            pagination: false,     // Sembunyikan dot halaman bawah jika tidak diperlukan
            breakpoints: {
                1280: {
                    perPage: 3,    // Layar laptop/tablet medium tampil 3
                },
                992: {
                    perPage: 2,    // Layar tablet tampil 2
                },
                640: {
                    perPage: 1,    // Layar HP tampil 1
                }
            }
        }).mount();
    });
